export default function SeminarFooter() {
  return (
    <div
      id="contact-seminar"
      className="relative h-[780px] sm:h-[650px] lg:h-[850px]"
      style={{ clipPath: "polygon(0% 0, 100% 0%, 100% 100%, 0 100%)" }}
    >
      <div className="relative h-[calc(100vh+780px)] sm:h-[calc(100vh+650px)] lg:h-[calc(100vh+850px)] -top-[100vh]">
        <div className="h-[780px] sm:h-[650px] lg:h-[850px] sticky top-[calc(100vh-780px)] sm:top-[calc(100vh-650px)] lg:top-[calc(100vh-850px)]">
          <div className="bg-neutral-900 py-6 sm:py-8 lg:py-10 px-4 sm:px-6 h-full w-full flex flex-col justify-between">
            <div className="flex flex-wrap shrink-0 gap-6 sm:gap-12 lg:gap-20">
              <div className="flex flex-col gap-1 sm:gap-2">
                ...
                <p className="text-white text-sm sm:text-base">Углублённый — <span className="text-amber-400 font-semibold">6 месяцев</span> (3 этапа по 2 месяца)</p>
                <p className="text-neutral-400 text-xs sm:text-sm mt-2">12 групповых занятий</p>
                <p className="text-neutral-400 text-xs sm:text-sm">6 индивидуальных консультаций</p>
                <p className="text-neutral-400 text-xs sm:text-sm">70 учебных часов</p>
              </div>
              <div className="flex flex-col gap-1 sm:gap-2">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-2 sm:gap-0">
              <h1 className="text-[9vw] sm:text-[8vw] lg:text-[7vw] leading-[0.85] mt-2 sm:mt-6 lg:mt-8 text-white font-bold tracking-tight">
                СЕМИНАР
              </h1>
